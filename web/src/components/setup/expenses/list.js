	...
	return (
		<div className="mt-4">
			...
			{Object.entries(groupByDay(data))
				.sort(([a], [b]) => a - b)
				.map(([day, expenses]) => (
					<div key={day} className="flex items-start border-t border-gray-300 first:border-transparent">
						...
						<div className="flex-grow p-2 -mx-1 flex flex-wrap items-center last:pb-0">
		...
		<div className="flex-shrink w-1/3 px-1">
			<div
				...
				<div className="flex items-center justify-between">
					<input type="checkbox" name="expenses" checked={isSelected} onChange={handleChange} className="hidden" />
